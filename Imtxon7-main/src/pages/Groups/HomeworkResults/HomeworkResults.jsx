  ...
  return (
    <div className={styles.container}>
      <div className={styles.header}>
        <button className={styles.backButton} onClick={() => navigate(`/groups/${id}?tab=1`)} title="Orqaga qaytish">
            ...
            {!loading && students.map((student, idx) => (
              <tr 
                ...
                onClick={() => {
                  ...
                  navigate(`/groups/${id}/homework/${homeworkId}/results/${student.id || student.student?.id || idx}?tab=${activeTab}&date=${dateToPass}`);
                }}
