...
import {  api  } from '../../../api';
import InfoOutlinedIcon from '@mui/icons-material/esm/InfoOutlined.js';;
import CloudUploadOutlinedIcon from '@mui/icons-material/esm/CloudUploadOutlined.js';;
import MicNoneOutlinedIcon from '@mui/icons-material/esm/MicNoneOutlined.js';;
...
export default function StudentHomeworkDetail() {
  ...
  const handleSubmit = async () => {
    try {
      ...
      navigate(`/groups/${id}/homework/${homeworkId}/results?tab=${searchParams.get('tab') || 'Kutayotganlar'}`);
    } catch (err) {
      ...
      <div className={styles.innerContainer}>
        ...
        <div className={styles.breadcrumb}>
          <button
            ...
            onClick={() => navigate(`/groups/${id}/homework/${homeworkId}/results?tab=${searchParams.get('tab') || 'Kutayotganlar'}`)}
          >
            {tabLabel}
          </button>
