...
import ChevronLeftRoundedIcon from '@mui/icons-material/esm/ChevronLeftRounded.js';;
  ...
  return (
    <div className={styles.container}>
      <div className={styles.header}>
        <button className={styles.backButton} onClick={() => navigate(`/groups/${id}?tab=1&subtab=Imtihonlar`)} title="Orqaga qaytish">
            ...
            {students.map((student, idx) => (
              <tr 
                ...
                onClick={() => {
                  ...
                  navigate(`/groups/${id}/exam/${examId}/results/${student.id || student.student?.id || idx}?tab=${activeTab}&date=${dateToPass}`);
                }}
