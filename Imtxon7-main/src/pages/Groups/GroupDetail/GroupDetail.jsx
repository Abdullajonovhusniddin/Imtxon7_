...
import AssessmentOutlinedIcon from '@mui/icons-material/esm/AssessmentOutlined.js';;
import KeyboardArrowLeftRoundedIcon from '@mui/icons-material/esm/KeyboardArrowLeftRounded.js';;
import KeyboardArrowRightRoundedIcon from '@mui/icons-material/esm/KeyboardArrowRightRounded.js';;
import KeyboardArrowDownRoundedIcon from '@mui/icons-material/esm/KeyboardArrowDownRounded.js';;
import KeyboardArrowUpRoundedIcon from '@mui/icons-material/esm/KeyboardArrowUpRounded.js';;
...
import PlayCircleOutlineRoundedIcon from '@mui/icons-material/esm/PlayCircleOutlineRounded.js';;
import CloseRoundedIcon from '@mui/icons-material/esm/CloseRounded.js';;
import CloudUploadOutlinedIcon from '@mui/icons-material/esm/CloudUploadOutlined.js';;
                                    ...
                                    {studyMonth.days.map(item => {
                                        ...
                                        return (
                                            <div
                                                ...
                                                onClick={() => {
                                                    if (!isFuture) {
                                                        navigate(`/groups/${id}/lesson/${dateStr}`);
                                                    }
                                                }}
                        ...
                        <button
                            ...
                            onClick={() => {
                                if (activeSubTab === "Videolar") {
                                    ...
                                    navigate(`/groups/${id}/homework/create`);
                                }
                            }}
                        >
                            Qo'shish
